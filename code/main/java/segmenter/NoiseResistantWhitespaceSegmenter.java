...
public class NoiseResistantWhitespaceSegmenter extends Segmenter {

	double dynamicThresholdRate = 0.25;
	...
	public NoiseResistantWhitespaceSegmenter(Preprocessor preprocessor) {
		super(preprocessor);
	}
	...
	public Set<Segment> segment(Image image) {
		...
		NewWhiteSpaceSegmenter segmenter = new NewWhiteSpaceSegmenter(preprocessor);
